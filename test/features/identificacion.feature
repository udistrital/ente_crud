...
Scenario Outline: To probe response route /identificacion       
  ...
  |GET   |/v1/identificacion|./files/req/Vacio.json|200 OK         |./files/res4/Vok1.json |
  |POST  |/v1/identificacion|./files/req/Vacio.json|400 Bad Request|./files/res4/Ierr1.json|
