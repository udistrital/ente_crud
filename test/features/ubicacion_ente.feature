...
Scenario Outline: To probe response route /ubicacion_ente       
  ...
  |GET   |/v1/ubicacion_ente|./files/req/Vacio.json|200 OK         |./files/res9/Vok1.json |
  |POST  |/v1/ubicacion_ente|./files/req/Vacio.json|400 Bad Request|./files/res9/Ierr1.json|
